...
model = AutoModelForCausalLM.from_pretrained("google/gemma-2b" , load_in_8bit = True)
...
results = {"mean_perplexity": ppl}

print("Mean Perplexity = ", ppl)

# with open("/home/test/harsh/llm/results/gemma_8_v2", "w") as outfile:
...
# with open("/home/test/harsh/llm/results/llama2_4.json", "w") as outfile:
#     json.dump(results, outfile)
